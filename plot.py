...
def final_out_dist(output_array, width, depth, Cw, Cb, Mu, Nboot, plot_type, rescale):
...
def output_dist_per_layer(A, width, depth, i, Cw, Cb, Mu, Nboot, plot_type, rescale):
